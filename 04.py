        ...
        for obj in tracked_objects:
            ...
            if class_id in vehicle_classes:
                ...
                if is_vehicle_crossing_line(line1_x, line1_y, line1_end_x, line1_end_y, centroid_x, centroid_y):
                    vehicles_crossed_first_line.add(obj_id)
                if obj_id in vehicles_crossed_first_line and is_vehicle_crossing_line(line2_x, line1_y, line2_end_x, line2_end_y, centroid_x, centroid_y):
